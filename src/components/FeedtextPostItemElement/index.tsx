...
export const FeedtextPostItemElement: FunctionComponent = ()=>{
                    ...
                    <div className="left-reactions-container">
                        ...
                        <div className="shareto-item-container">
                            <button>
                                ...
                                >
                                    <path d="M 16.1 260.2 c -22.6 12.9 -20.5 47.3 3.6 57.3 L 160 376 V 479.3 c 0 18.1 14.6 32.7 32.7 32.7 c 9.7 0 18.9 -4.3 25.1 -11.8 l 62.311 -74.531 l 123.9 51.6 c 18.9 7.9 40.8 -4.5 43.9 -24.7 l 64 -416 c 1.9 -12.1 -3.4 -24.3 -13.5 -31.2 s -23.3 -7.5 -34 -1.4 l -448 256 z m 34.988 25.859 L 436.192 64.88 L 192.266 343.315 l 0.785 -0.784 L 51.872 287.628 z M 402.466 429.591 L 237.757 361.355 L 472.271 76.644 L 412.662 433.513 z"></path>
                                </svg>
                            </button>
...
export default FeedtextPostItemElement;